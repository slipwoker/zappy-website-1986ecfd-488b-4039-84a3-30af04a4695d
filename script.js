document.addEventListener('DOMContentLoaded', function () {
  ...
  if (contactForm) {
    ...
    function validateField(field) {
      ...
      if (value !== '') {
        ...
        if (minLength && value.length < parseInt(minLength, 10)) {
          showError(field, field.getAttribute('data-error-minlength') || 'Minimum length is ' + minLength + ' characters.');
          return false;
        }

        if (maxLength && value.length > parseInt(maxLength, 10)) {
          showError(field, field.getAttribute('data-error-maxlength') || 'Maximum length is ' + maxLength + ' characters.');
          return false;
        }
      }
    ...
    contactForm.addEventListener('submit', function (e) {
      ...
      var successMsg = contactForm.querySelector('.form-success-message');
      if (!successMsg) {
    ...
    "translations": {
      "he": {
        "consentModal": {
          ...
          "description": "Ayalot משתמש בעוגיות כדי לשפר את החוויה שלך, לנתח שימוש באתר ולסייע במאמצי השיווק שלנו.",
...
(function() {
    ...
    contactForm.addEventListener('submit', async function(e) {
        ...
        try {
            ...
            var payload = {
                websiteId: '1986ecfd-488b-4039-84a3-30af04a4695d',
                name: resolvedName,
                email: resolvedEmail,
            ...
            if (result.success) {
                ...
                if (result.thankYouPagePath && result.ticketNumber) {
                    ...
                    if (isPreview && window.ZAPPY_CONFIG) {
                        var wid = window.ZAPPY_CONFIG.websiteId || '1986ecfd-488b-4039-84a3-30af04a4695d';
...
(function(){
  try {
    ...
    document.addEventListener('submit', function(e) {
      ...
      var wid = '1986ecfd-488b-4039-84a3-30af04a4695d';
